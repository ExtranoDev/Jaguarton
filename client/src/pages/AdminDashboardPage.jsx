    ...
    <div className="flex h-screen flex-col overflow-hidden bg-paper">
      ...
      <div className="flex-grow overflow-y-auto">
        ...
        <div className="px-4 pt-4 sm:px-8">
          <div role="tablist" aria-label="Admin sections" className="-mx-4 flex gap-2 overflow-x-auto px-4 pb-1 sm:mx-0 sm:flex-wrap sm:px-0">
            {TABS.map((tab) => (
              <button
                key={tab.id}
                type="button"
                ...
                className={`flex-shrink-0 whitespace-nowrap rounded-full px-4 py-2 text-[13px] ${
